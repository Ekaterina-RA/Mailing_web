...
from .views import (
    ...
    MailingAttemptListView, MailingAttemptDetailView, MessagingHomeView)
...
urlpatterns = [
    ...
    path('attempts/<int:mailing_id>/', MailingAttemptListView.as_view(), name='mailing_attempts'),
    path('attempts/detail/<int:pk>/', MailingAttemptDetailView.as_view(), name='attempt_detail'),
]